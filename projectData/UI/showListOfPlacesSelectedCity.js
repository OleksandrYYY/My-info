...
//             initialData.map = UI.initializeMap(center, 10);
//         };
...
export function showListOfPlacesSelectedCity(places, blockInfoAboutPlacesCity, tableInformationOfCountries, initialData, mapContainer) {
    blockInfoAboutPlacesCity.innerHTML = "";
    const ul = document.createElement("ul");
    ...
    places.forEach((place) => {
        ...
        UiAction.handlerEvents(li, "click", () => {
            ...
            UiAction.handlerEvents(btnBack, "click", () => {
                descriptionOfPlace.remove();
                blockInfoAboutPlacesCity.style.display = "block";
                UI.showListOfPlacesSelectedCity(places, blockInfoAboutPlacesCity, tableInformationOfCountries, initialData, mapContainer);
            });
        });
